...
-- Tiempo de generación: 04-09-2020 a las 01:05:14
...
(1, 'Isabel', 'isabel@correo.com', 'Unas vacaciones muy buenas en formentera '),
(2, 'Sergio', 'sergio@correo.com', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book'),
(3, 'Pedro', 'pedro@correo.com', 'El viaje a Venecia fue muy bueno y espero que mucha gente vaya a venecia a disfrutar de sus vacaciones y discotecas'),
(4, 'Sergio Controller', 'correo@correo', 'Desde el Controller'),
(5, 'Sergio async await', 'correo@correo', 'Este mensaje es para probar');
...
CREATE TABLE IF NOT EXISTS `viajes` (
  ...
  `imagen` varchar(20) COLLATE latin1_spanish_ci NOT NULL,
  `descripcion` longtext COLLATE latin1_spanish_ci NOT NULL,
  `disponibles` varchar(3) COLLATE latin1_spanish_ci NOT NULL,
  PRIMARY KEY (`id`)
